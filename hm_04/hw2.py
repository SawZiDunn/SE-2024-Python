...
def main():
    ...
    turtle.penup()
    turtle.goto(x1, y1) # first rectangle center
    turtle.pendown()
    turtle.write(f"({x1}, {y1})")

    turtle.penup()
    turtle.goto(x1 - half_width1, y1 - half_height1) # bottom left point
    turtle.pendown()

    turtle.left(90)
    turtle.forward(rectangle_height1)
    turtle.right(90)
    turtle.forward(rectangle_width1)
    turtle.right(90)
    turtle.forward(rectangle_height1)
    turtle.right(90)
    turtle.forward(rectangle_width1)
    ...
    turtle.penup()
    turtle.goto(x2, y2) # second rectangle center
    turtle.pendown()
    turtle.write(f"({x2}, {y2})")

    turtle.penup()
    turtle.goto(x2 - half_width2, y2 - half_height2) # bottom left point
    turtle.pendown()

    turtle.right(90)
    turtle.forward(rectangle_height2)
    turtle.right(90)
    turtle.forward(rectangle_width2)
    turtle.right(90)
    turtle.forward(rectangle_height2)
    turtle.right(90)
    turtle.forward(rectangle_width2)
    ...
    if left2 <= left1 and right2 >= right1 and top2 >= top1 and bottom2 <= bottom1:
        ...
        turtle.write("Two rectangle are overlapping with one another.")
    else:
